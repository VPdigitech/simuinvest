...
export default function Article() {
  return (
    <>
      <SeoHead title="Article SimuInvest 2026" description="Guide complet sur les placements financiers français." slug="blog/scpi-pour-debutant-moins-1000-euros" type="article"/>
      <Nav/>
      <article>
